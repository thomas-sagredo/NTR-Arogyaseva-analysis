...
#ver variable dias de internacion. revisar.MAS DIAS PASEN BAJA LA PROBABILIDAD DE QUE FALLEZCA
#pasar log con standarizacion con las numericas.
...
summary(glmm_nulo_distrito_hospital). #revisar. SI DA BIEN INTERPRETACION
